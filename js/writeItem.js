...
exports.handler = (event, context, callback) => {
    ...
    var runId = "123456";
    var date = "Sept-05-2021";
    var distance = 3;
    var runLocation = "Park";
    var notes = "Notes about run";
    writeItem(runId, date, distance, runLocation, notes).then(() => {
...
function writeItem(runId, date, distance, runLocation, notes) {
